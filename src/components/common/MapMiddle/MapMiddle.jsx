...
import mapMiddleMobile from "../../../assets/images/service/map/map-mobile.png";
import mapMiddleTablet from "../../../assets/images/service/map/map-tablet.png";
import mapMiddleDesktop from "../../../assets/images/service/map/map-desktop.png";
  ...
  return (
    <section className={styles.mapMiddle}>
      <div className={styles.mapMiddle__container}>
        ...
        <div className={classNames(styles.mapMiddle__imgWrapper)}>
          {isHomepage ? (
            <>
              <div
                className={classNames(styles.mapMiddle__img__desktopHidden)}
              />
